...
const firebaseConfig = {
  ...
  storageBucket: "tangochallenge-5b793.appspot.com", // Pataisytas storage bucket pavadinimas
...
// Nustatome teisių reguliavimai duomenų rašymui
// Tai leidžia rašyti duomenis be autentifikacijos
firebase.database().ref().child('temporary_videos').onDisconnect().cancel();
